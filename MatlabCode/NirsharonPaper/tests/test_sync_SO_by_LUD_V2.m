...
p = .5;%.7;  % the probability of non-outliers
...
estimations = sync_SO_by_LUD_V2(Affin_mat, confidence_weights, k );
error_LUD = error_calc_SO_k(estimations, SOk_array)
